...
class _HomeScreenState extends State<HomeScreen> {
  ...
  late DatabaseService firestore;
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    firestore = DatabaseService(uid: "");
    loadProduct();
  }
  ...
  loadProduct() async {
    await firestore
        ...
        .then((value) => listProduct = value);
    setState(() {});
    print("so san pham: " + listProduct.length.toString());
  }
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: FutureBuilder<List<Uint8List>>(
                              future: storage.loadListImages(listProduct),
                              builder: (context, snapshot) {
                                listImage = snapshot.data ?? [];
                                return listImage.length != listProduct.length
                                    ? Text("Loading...")
